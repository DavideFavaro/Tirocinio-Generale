...
if __name__ == "__main__":
  ...
  while tvalue<=50:
    ...
    element=sediment(args.final_time,args.input,args.depth,
                     args.dx,args.dy,args.xcoord,tvalue,
  ...
  # with open('/home/francesco/Scrivania/risultato.csv', 'w') as writeFile:
  #   writer = csv.writer(writeFile)
  #   writer.writerows(risultato)
